...
public class DesignHelperImplTest extends AbstractRemoteTest {
    ...
    public void testImgTag_String_Page() {
        ...
        String path = "";
        Page page = null;
        DesignHelperImpl instance = new DesignHelperImpl();
        String expResult = "";
        String result = instance.imgTag(path, page);
    ...
    public void testImgTag_3args_1() {
        ...
        DesignHelperImpl instance = new DesignHelperImpl();
        String expResult = "";
        String result = instance.imgTag(path, page, attrs);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    public void testImgSrc() {
        ...
        DesignHelperImpl instance = new DesignHelperImpl();
        String expResult = "";
        String result = instance.imgSrc(path, page);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    public void testScriptTag() {
        ...
        DesignHelperImpl instance = new DesignHelperImpl();
        String expResult = "";
        String result = instance.scriptTag(path, page);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    public void testScriptSrc() {
        ...
        DesignHelperImpl instance = new DesignHelperImpl();
        String expResult = "";
        String result = instance.scriptSrc(path, page);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
